class ScraperService
  ...
  class << self
    def start_scraping
      departure_dates = DepartureDate.scraping_departure_dates
    ...
    def complete_scraping_process(departure_date, airport, destination_airport)
      ...
      begin
        ...
        # return if check_search_not_found due to website ajax loading delay issue or to 
        # to avoid too many http request issue or if ticket search parameters are not suitable
    ...
    def search_flight(departure_date, airport, destination_airport)
      ...
      begin
        ...
        # Wait 1s to load the page properly
        # We should not avoid this, because it will increase average execution time
        sleep(1)
